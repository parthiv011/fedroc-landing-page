...
export const Logo = ({ classname }: { classname?: string }) => {
  return (
    <Link href="/" className={cn('flex items-center gap-2', classname)}>
      <LogoIcon className="h-12 w-auto text-neutral-600 dark:text-neutral-400" />
      <span className="text-md font-bold text-neutral-600 dark:text-neutral-400">
        Fedroc
      </span>
    </Link>
  );
...
export const LogoIcon = (props: React.SVGAttributes<SVGSVGElement>) => {
  return (
    <svg
      ...
      viewBox="0 0 512 512" // keep your original viewBox
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        fill="currentColor" // <-- now color is dynamic
